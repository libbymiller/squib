...
Squib::Deck.new(width: 825, height: 1125, cards: 1) do
  ...
  png file: 'sprites.png', x: 300, y: 350, # just the robot golem image
      crop_x: 0, crop_y: 0, crop_corner_radius: 10,
      crop_width: 64, crop_height: 64
  png file: 'sprites.png', x: 375, y: 350, # just the drakkar ship image
      crop_corner_x_radius: 10, crop_corner_y_radius: 20
